...
# data=Data_Single(box=[-1,1,-1,1],device='cpu')

# out,inner=data.sampleDomain_hole(10000)
# indata,_=data.sphere_bound(1000)
# interface=data
# out=out.numpy()
# inner=inner.numpy()
# import matplotlib.pyplot as plt
# plt.scatter(out[:,0],out[:,1],label='out')
# plt.scatter(inner[:,0],inner[:,1],label='inner')
# plt.scatter(indata[:,0],indata[:,1],label='interface')
# plt.legend()
# plt.show()
